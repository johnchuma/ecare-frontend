...
import 'package:doctor/modules/pharmacy/Pharmacy_product_page.dart';
import 'package:doctor/modules/pharmacy/pages/pharmacy_transaction_page.dart';
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: customAvatar(50, user.image),
                  ),
                  GestureDetector(
                      onTap: () {
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    {
                      'name': option("Income"),
                      'widget': const PharmacyTransactionPage()
                    },
                    {'name': option("Posts"), 'widget': const PostsPage()},
                    {
                      'name': option("Products"),
                      'widget': Container(child: const PharmacyProductPage())
                    },
                    {
                      'name': option("Orders"),
                      'widget': Container(child: const MyOrders())
                    },
                  ]
